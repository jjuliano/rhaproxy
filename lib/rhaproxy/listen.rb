  ...
  class RhaproxyListen
    ...
    #
    attr_accessor :http_check_expect
    ...
    #              about ACL usage.
    #
    attr_accessor :stats_http_request
    ...
    #              extraction.
    #
    attr_accessor :stick_store_request
    ...
    #              extraction.
    #
    attr_accessor :stick_store_response
    ...
    #
    attr_accessor :tcp_response_content
    ...
    #
    attr_accessor :tcp_response_inspect_delay
    ...
    #
    # Compile the HAproxy listen configuration
    #
    def config
    ...
    def option_string()
      ...
      if @appsession
        ostring += "    " + "appsession " + @appsession.to_s + "\n"
      end
      ...
      if @dispatch
        ostring += "    " + "dispatch " + @dispatch.to_s + "\n"
      end
      ...
      if @http_check_expect
        ostring += "    " + "http-check expect " + @http_check_expect.to_s + "\n"
      end
      ...
      if @server
        ostring += "    " + "server " + @server.to_s + "\n"
      end

      if @stats_http_request
        ostring += "    " + "stats http-request " + @stats_http_request.to_s + "\n"
      end

      if @stick_match
        ostring += "    " + "stick match " + @stick_match.to_s + "\n"
      end

      if @stick_on
        ostring += "    " + "stick on " + @stick_on.to_s + "\n"
      end

      if @stick_store_request
        ostring += "    " + "stick store-request " + @stick_store_request.to_s + "\n"
      end

      if @stick_table
        ostring += "    " + "stick table " + @stick_table.to_s + "\n"
      end

      if @stick_store_response
        ostring += "    " + "stick store-response " + @stick_store_response.to_s + "\n"
      end
      ...
      if @tcp_response_content
        ostring += "    " + "tcp-response content " + @tcp_response_content.to_s + "\n"
      end

      if @tcp_response_inspect_delay
        ostring += "    " + "tcp-response inspect-delay " + @tcp_response_inspect_delay.to_s + "\n"
      end
      ...
      if @stats_admin
        ostring += "    " + "stats admin " + @stats_admin.to_s + "\n"
      end
